import 'package:fiiland/common_widget/icon_title_next_row.dart';
import 'package:fiiland/view/workout_tracker/exercises_step_details.dart';
import 'package:fiiland/view/workout_tracker/workout_schedule_view.dart';
                    ...
                    children: [
                      ...
                      ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return ExercisesSetSection(sObj: sObj, onPressed: ((obj) {
                              Navigator.push(context, MaterialPageRoute(builder:(context)=>ExercisesStepDetails(eObj: sObj,),),);  
                            })
                            );
                          }),
                      SizedBox(
